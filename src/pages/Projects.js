...
function Projects() {
  return (
    <div className="jumbotron container">
      ...
      <p className="lead">
        This page contains all the projects done for this class, the{" "}
        <i className="fab fa-github"></i> icon will take you to the repo and the
        <svg
          width="1em"
          height="1em"
          viewBox="0 0 16 16"
        ...
        icon will take you to the web page
      </p>
      <hr className="my-4" />
